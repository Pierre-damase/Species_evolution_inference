...
def compute_stairway_inference(simulation, path_stairway, path_data, fold):
    ...
    if tau in tau_list and kappa in kappa_list:
        ...
        os.system("mv {} /home/pimbert/work/Species_evolution_inference/Figures/Stairway/{}" \
    ...
    if args.analyse == 'data':
        ...
        if args.dadi:
            ...
            if args.param is None:
                path_inf = "/home/pimbert/work/Species_evolution_inference/Data/Dadi/{}/all/" \
                    .format(args.model)
            else:
                path_inf = "/home/pimbert/work/Species_evolution_inference/Data/Dadi/{}/{}/" \
